<?php
// FROM HASH: 43488d39f2040eb5e7207349784bbc91
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
';
	$__templater->pageParams['pageH1'] = $__templater->preEscaped($__templater->escape($__vars['thread']['title']));
	$__finalCompiled .= '
	';
	if ($__vars['next']) {
		$__finalCompiled .= '
...
';
	...
	$__finalCompiled .= '
';
	$__templater->breadcrumb($__templater->preEscaped($__templater->func('prefix', array('thread', $__vars['thread'], 'html', '', ), true) . ' ' . $__templater->escape($__vars['thread']['title'])), '', array(
	));
	$__finalCompiled .= '
';
