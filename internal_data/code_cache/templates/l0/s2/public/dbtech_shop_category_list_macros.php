<?php
// FROM HASH: 23eb89acc4585f7b1556049b6fefaee3
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('dbtech-shop/categories', $__vars['category'], ), true) . '" class="categoryList-link' . ($__vars['isSelected'] ? ' is-selected' : '') . '">
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="node node--depth2 node--itemCategory node--itemCategory' . $__templater->escape($__vars['category']['category_id']) . '">
		<div class="node-body">
	...
	$__finalCompiled .= '
				<h3 class="node-title">
					<a href="' . $__templater->func('link', array('dbtech-shop/categories', $__vars['category'], ), true) . '" data-xf-init="' . (($__vars['descriptionDisplay'] == 'tooltip') ? 'element-tooltip' : '') . '" data-shortcut="node-description">' . $__templater->escape($__vars['category']['title']) . '</a>
				</h3>
				';
	...
	if ($__vars['extras']['last_update']) {
		$__finalCompiled .= '
					<div class="node-extra-row"><a href="' . $__templater->func('link', array('dbtech-shop', array('item_id' => $__vars['extras']['last_item_id'], 'title' => $__vars['extras']['last_item_title'], ), ), true) . '" class="node-extra-title" title="' . $__templater->escape($__vars['extras']['last_item_title']) . '">' . $__templater->escape($__vars['extras']['last_item_title']) . '</a></div>
