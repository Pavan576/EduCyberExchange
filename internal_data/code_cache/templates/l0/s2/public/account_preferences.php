<?php
// FROM HASH: 0786365736ab0141ec4493f3aed54b48
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
';
	$__templater->inlineJs('var myElement = document.querySelector(\'input[name="custom_fields[userbarhue]"]\');
myElement.setAttribute("type", "range");');
	$__finalCompiled .= '
