<?php
// FROM HASH: 4bfc7eb181f2be6c702fc43dae503b5d
return array(
	...
	if ($__vars['thread']['discussion_state'] == 'deleted') {
		...
		$__finalCompiled .= '
					<ul class="structItem-parts">
						<li>by ' . $__templater->func('username_link', array($__vars['thread']['User'], false, array(
			'defaultname' => $__vars['thread']['username'],
		))) . '</li>
