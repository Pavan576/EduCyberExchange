<?php
// FROM HASH: 01ce0f29b90e207b1845671ac1d9614c
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['button'] = $__templater->preEscaped('
		<a class="reply-button button--multiQuote"
			style="display: none;"
			data-xf-init="multi-quote"
			data-href="' . $__templater->escape($__vars['href']) . '"
			data-message-selector="' . $__templater->escape($__vars['messageSelector']) . '"
			data-storage-key="' . $__templater->escape($__vars['storageKey']) . '"
			data-add-message="' . $__templater->escape($__vars['addMessage']) . '"
			data-remove-message="' . $__templater->escape($__vars['removeMessage']) . '"
			icon="quote">
