<?php
// FROM HASH: 888182c6075c57d5d687ac4c2997e86e
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<a href="' . $__templater->func('link', array('attachments/upload', null, array('type' => $__vars['type'], 'context' => $__vars['context'], 'hash' => $__vars['hash'], ), ), true) . '"
		target="_blank" class="reply-button button--link js-attachmentUpload" icon="attach"
		data-accept=".' . $__templater->filter($__vars['constraints']['extensions'], array(array('join', array(',.', )),), true) . '"
	   data-video-size="' . $__templater->escape($__vars['constraints']['video_size']) . '">Attach Files</a>
