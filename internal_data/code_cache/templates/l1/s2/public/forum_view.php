<?php
// FROM HASH: 24bb28878fa4b9e25a49ab413a2902d8
return array(
...
';
	if ($__templater->method($__vars['forum'], 'canCreateThread', array()) OR $__templater->method($__vars['forum'], 'canCreateThreadPreReg', array())) {
		$__finalCompiled .= '
	<a href="' . $__templater->func('link', array('forums/post-thread', $__vars['forum'], ), true) . '" class="profile_message" icon="write" rel="nofollow" style="color: #fff;
    border: 1px solid #444;
    border-radius: 50px !important;
    padding: 0.5rem 0.7rem;">
		<span style="font-weight:500 !important; font-size: 14px;"><i class="fas fa-plus" style="margin-right:5px;"></i> Create New Topic</span>
	</a>
';
	}
	$__finalCompiled .= '
